...
TE-Wellen
	\begin{align*}
		Z_\text{FH} &= \pm\frac{\vc{E}_x}{\vc{H}_y} = \mp\frac{\vc{E}_y}{\vc{H}_x}\\
		&= \frac{\omega\mu}{\beta} = \frac{\omega\mu}{\beta_0\sqrt{1-\left(\frac{\beta_c}{\beta_0}\right)^2}} = \frac{Z_\text{F}}{\sqrt{1-\left(\frac{\beta_c}{\beta_0}\right)^2}} = \frac{Z_\text{F}}{\sqrt{1-\left(\frac{f_c}{f_0}\right)^2}} = \frac{Z_\text{F}}{\sqrt{1-\left(\frac{\lambda_0}{\lambda_c}\right)^2}}
	\end{align*}
TM-Wellen
	\begin{align*}
		Z_\text{FE} &= \pm\frac{\vc{E}_x}{\vc{H}_y} = \mp\frac{\vc{E}_y}{\vc{H}_x} = \frac{\beta}{\omega\varepsilon} = \frac{\beta_0\sqrt{1-\left(\frac{\beta_c}{\beta_0}\right)^2}}{\omega\varepsilon} \\
		&= Z_\text{F} \sqrt{1-\left(\frac{\beta_c}{\beta_0}\right)^2} = Z_\text{F} \sqrt{1-\left(\frac{f_c}{f_0}\right)^2} = Z_\text{F} \sqrt{1-\left(\frac{\lambda_0}{\lambda_c}\right)^2}
	\end{align*}
TEM-Wellen
	\begin{equation*}
		\frac{\vc{E}_x}{\vc{H}_y} = -\frac{\vc{E}_y}{\vc{H}_x} = \pm\frac{\omega\mu}{\beta} = \pm\sqrt{\frac{\mu}{\varepsilon}} = \pm Z_F \qquad Z_{\text{F}0} = \sqrt{\frac{\mu_0}{\varepsilon_0}} = 120\pi\Omega = 377\Omega
	\end{equation*}
\HL
...
Wirkleistung
	\begin{equation*}
		P_{wai}=\frac{1}{2}\c{a}_i\c{a}_i^*=\frac{\c{U}_{\text{h}i}\c{U}_{\text{h}i}^*}{2\c{Z}_{\text{L}i}}=\frac{1}{2}|\c{a}_i|^2 \qquad P_{wbi}=\frac{1}{2}\c{b}_i\c{b}_i^*=\frac{\c{U}_{\text{r}i}\c{U}_{\text{r}i}^*}{2\c{Z}_{\text{L}i}}=\frac{1}{2}|\c{b}_i|^2
	\end{equation*}
\subsection{Matrizen}
Streumatrix
	\begin{equation*}
...
Reflexions- und Transmissionsfaktoren
	\begin{equation*}
		\c{S}_{ii}=\frac{\c{Z}_{\text{E}i}-\c{Z}_{\text{L}i}}{\c{Z}_{\text{E}i}+\c{Z}_{\text{L}i}} \qquad \c{S}_{ji}=2\frac{\c{U}_j}{\c{U}_{0i}}\sqrt{\frac{\c{Z}_{\text{L}i}}{\c{Z}_{\text{L}j}}} \qquad \parbox{0.4\linewidth}{Statt Spannungsverhältnis Widerstandsverhältnis einsetzen (Bei Dreitoren verketteten Spannungsteiler benutzen!)}
	\end{equation*}
...
\HL\\
zusammengestellt von \textsc{Tino Steinmetz} und \textsc{Hermann Pommerenke},\\ basierend auf der Vorlesung von \textsc{Prof. Tobias Weber}\\ \textsc{Universität Rostock}, SS 2015
\end{multicols}	
