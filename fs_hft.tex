...
\subsection{Koaxialleitung}
	Wellenwiderstand
	\begin{equation*}
		Z_\text{L}=\frac{1}{2\pi}Z_{\text{F}0}\ln\left(\frac{D}{d}\right)
	\end{equation*}
	Leistung
	\begin{equation*}
		P=\frac{1}{2}Z_\text{L}I^2_{\text{max}}=\frac{1}{2}\frac{U^2_{\text{max}}}{Z_\text{L}}
	\end{equation*}
	Feldstärken
	\begin{equation*}
...
\subsection{Ablesen und Antragen der Werte}
	...
	\begin{equation*}
		r=\frac{\c{Z}-\c{Z_L}}{\c{Z}+\c{Z}_L}=\frac{\c{z}-1}{\c{z}+1}\qquad s=\frac{1}{m}=\frac{1+|r|}{1-|r|}
	\end{equation*}
\end{multicols}	
