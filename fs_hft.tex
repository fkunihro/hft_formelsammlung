...
Richtfaktor
	\begin{equation*}
		D=\frac{S_{\text{max}}}{S_0}	=\frac{S_{\text{max}}}{P}\cdot4\pi r^2 \qquad \text{bzw.} \qquad D(\vartheta,\varphi)=\frac{S(\vartheta,\varphi)}{S_0} \qquad \boxed{D_{Kugel}=\frac{S_0}{S_0}=1}	
	\end{equation*}
...
%\HL
\section{Zweitore}
%Anwendung auf Mehrtore: reflexionsfreier Abschluss nicht betrachteter Tore
...
Reflexions- und Transmissionsfaktoren
	\begin{equation*}
		\c{S}_{ii}=\frac{\c{Z}_{\text{E}i}-Z_{\text{L}i}}{\c{Z}_{\text{E}i}+Z_{\text{L}i}} \qquad \c{S}_{ji}=2\frac{\c{U}_j}{\c{U}_{0i}}\sqrt{\frac{Z_{\text{L}i}}{Z_{\text{L}j}}} \qquad \parbox{0.4\linewidth}{Statt Einzelspannungen Spannungsteiler einsetzen. Auf Parallelschaltungen Achten}
	\end{equation*}
