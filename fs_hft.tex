...
\subsection{Abstandsabhängige komplexe Wellenamplituden}
	...
	\begin{align*}
		\c{a}(z)&=\c{a}_0(z)e^{-j\beta z} & \c{\Gamma}_0&=\frac{\c{b}_0}{\c{a}_0}\\ 
	...
	\begin{equation*}
		\c{a}(z)=\frac{\c{U}(z)}{\sqrt{Z_\text{L}}}=\pm \sqrt{Z_\text{L}}\c{I}(z)
	\end{equation*}
\section{Zweitore}
...
Reflexionsfaktoren
	\begin{equation*}
		\c{S}_{ii}=\frac{Z_{\text{E}i}-Z_{\text{L}i}}{Z_{\text{E}i}+Z_{\text{L}i}}
	\end{equation*}
Transmissionsfaktoren
	\begin{equation*}
		\c{S}_{ji}=\frac{2U_j}{U_{0i}}\sqrt{\frac{Z_{\text{L}i}}{Z_{\text{L}j}}} \qquad \mbox{Statt Spannungsverhältnis Widerstandsverhältnis einsetzen}
	\end{equation*}
