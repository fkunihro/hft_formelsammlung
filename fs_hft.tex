...
Richtfaktor
	\begin{equation*}
		D=\frac{S_{\text{max}}}{S_0}	=\frac{S_{\text{max}}}{P}\cdot4\pi r^2 \qquad \text{bzw.} \qquad D(\vartheta,\varphi)=\frac{S(\vartheta,\varphi)}{S_0} \qquad D_{Kugel}=\frac{S_0}{S_0}=1	
	\end{equation*}
...
Verkettung
	\begin{equation*}
		\c{\matr{T}}=\c{\matr{T}}^{(1)}\cdot\c{\matr{T}}^{(2)} \qquad \c{\matr{S}}\neq\c{\matr{S}}^{(1)}\cdot\c{\matr{S}}^{(2)}\textbf{!!!}
	\end{equation*}
	%\begin{empheq}[box=\fbox]{equation*}
	%	\c{\matr{S}}\neq\c{\matr{S}}^{(1)}\cdot\c{\matr{S}}^{(2)}\textbf{!!!}
	%\end{empheq}
