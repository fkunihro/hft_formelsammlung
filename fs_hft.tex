...
TEM-Wellen
	\begin{align*}
		...
		Z_{\text{F}0} &= \sqrt{\frac{\mu_0}{\varepsilon_0}} = 120\pi\Omega = 377\Omega
	\end{align*}
\HL
...
Strahlungsleistungsdichte (Kugel/Dipol)
	\begin{equation*}
		S_0=\frac{P}{4\pi r^2} \qquad S(\vartheta,\varphi)=\frac{1}{2}Z_\text{F}\left(\frac{\beta|\c{I}_0|l\sin(\vartheta)}{4\pi r}\right)^2	
	\end{equation*}
Richtfaktor
	\begin{equation*}
...
Reflexions- und Transmissionsfaktoren
	\begin{equation*}
		\c{S}_{ii}=\frac{\c{Z}_{\text{E}i}-\c{Z}_{\text{L}i}}{\c{Z}_{\text{E}i}+\c{Z}_{\text{L}i}} \qquad \c{S}_{ji}=\frac{2\c{U}_j}{\c{U}_{0i}}\sqrt{\frac{\c{Z}_{\text{L}i}}{\c{Z}_{\text{L}j}}} \qquad \parbox{0.4\linewidth}{Statt Spannungsverhältnis Widerstandsverhältnis einsetzen}
	\end{equation*}
