...
\subsection{Helmholtzgleichungen}
	\begin{equation*}
		\bigtriangleup\vc{H}+\beta^2_\text{c}\vc{H}=0 \qquad \bigtriangleup\vc{E}+\beta^2_\text{c}\vc{E}=0
	\end{equation*}
\HL
...
Reflexions- und Transmissionsfaktoren
	\begin{equation*}
		\c{S}_{ii}=\frac{\c{b}_i}{\c{a}_i}=\frac{\c{Z}_{\text{E}i}-Z_{\text{L}i}}{\c{Z}_{\text{E}i}+Z_{\text{L}i}} \qquad \c{S}_{ji}0\frac{\c{b}_j}{\c{a}_i}=2\frac{\c{U}_j}{\c{U}_{0i}}\sqrt{\frac{Z_{\text{L}i}}{Z_{\text{L}j}}} \qquad \parbox{0.4\linewidth}{Statt Einzelspannungen Spannungsteiler einsetzen. Auf Parallelschaltungen Achten}
	\end{equation*}
